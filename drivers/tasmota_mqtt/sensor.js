...
const SensorsCapabilities = {
    ...
    'UvLevel': [
        { sensor_filter: '*',               caption: 'UV index ({sensor})',              capability: 'measure_ultraviolet.{sensor}',                value_converter: null,                  units: { default: '',           units_field: null,                  units_template: '{value}' } },
    ],
    'Frequency': [
    ...
    'Factor': [
        ...
        { sensor_filter: '*',               caption: 'Power factor ({sensor})',          capability: 'measure_power_factor.{sensor}',               value_converter: null,                  units: { default: '',           units_field: null,                  units_template: '{value}' } },
    ],
    'ApparentPower': [
    ...
    'A':[
        { sensor_filter: '*',               caption: 'Analog {index} ({sensor})',        capability: 'measure_analog.{sensor}.{index}',             value_converter: null,                  units: { default: '',           units_field: null,                  units_template: '' } },
    ],
    'Switch': [
...
const getPropertyObjectForSensorField = (path, cache_result) => {
    ...
    else if (path[0] !== 'ZbReceived') // ignoring Zigbee sensors for now
    {
