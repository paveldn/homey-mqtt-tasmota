...
var ZigbeeSensorCapabilities = {
	'CapabilitiesTemplates' : {
		'Temperature': [
			{ sensor_filter: '*',               caption: null,      capability: 'measure_temperature',          value_converter: null,                  	units: null },
		],
		'Humidity': [
		...
		'0500<00': [
			{ sensor_filter: '*',               caption: null,		capability: 'alarm_water',                  value_converter: WaterAlarmConverter,    	units: null },
		],
	},
	'Cache' : {}
}
